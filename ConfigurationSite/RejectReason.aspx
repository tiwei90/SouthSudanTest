<%@ Page Language="C#" MasterPageFile="~/iden.master" AutoEventWireup="true" Inherits="RejectReason" Codebehind="RejectReason.aspx.cs" %>
<asp:Content ID="Content2" ContentPlaceHolderID="Content" Runat="Server">
   <asp:Panel ID="Panel1" runat="server" BackImageUrl="./images/bg.gif" Height="24px"
        ...
        <asp:Label ID="fly" runat="server" BackColor="Transparent" CssClass="HeaderMainTitle"
            Height="16px" Width="353px">Visa - Reject Reason </asp:Label></asp:Panel>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="Title" style="height: 20px; background-color: #c6efef;">
                            <asp:Label ID="Label3" runat="server" Text="List of Reject Reasons" CssClass="LabelHeadGreen"
                    ...
                    <tr>
                        ...
                        <td align="center" style="width: 782px">                        
                            <asp:GridView ID="gvRReason" runat="server" AllowPaging="True" CellPadding="3" CssClass="Label"
                                ForeColor="#333333" GridLines="None" PageSize="5" 
                                OnPageIndexChanging="PageIndexChanging_Click"  
                                 OnSelectedIndexChanged="gvRReason_SelectedIndexChanged" AutoGenerateColumns="False" Width="781px">
                                <PagerSettings FirstPageText="&lt;&lt;" PreviousPageText="Previous" NextPageText="Next"
                                    LastPageText="&gt;&gt;"></PagerSettings>
                                <Columns>
                                    <asp:BoundField DataField="ID" HeaderText="ID" />
                                    <asp:BoundField DataField="REJECTREASONCODE" HeaderText="REJECT REASON CODE" />
            ...
            <table id="TABLE1" cellspacing="0" cellpadding="0" width="100%" border="0" runat="server">
                ...
                <tr>
                    ...
                    <td style="height: 20px; background-color: #c6efef; width: 803px;" class="Title" colspan="1">
                        <asp:Label ID="Label1" runat="server" Width="300px" Text="Insert New Reject Reason"
                            ...
                            <tbody>
                                <tr>
                                    <td style="width: 170px; height: 19px">
                                        <asp:Label ID="Label9" runat="server" CssClass="Label" Text="ID" Width="14%"></asp:Label><asp:Label
                                            ID="Label13" runat="server" CssClass="Label" Font-Bold="False" ForeColor="Red"
                                            Text="*"></asp:Label></td>
                                ...
                                <tr style="color: #000000">
                                    <td style="width: 170px; height: 19px">
                                        <asp:Label ID="Label14" runat="server" CssClass="Label" Text="Reject Reason Code"
                                            Width="78%"></asp:Label>
                                    ...
                                    <td style="width: 10px; height: 19px">
                                        :</td>
                                    <td style="width: 640px; height: 19px">
                                        <asp:TextBox ID="txtRReason" runat="server" MaxLength="2"></asp:TextBox>
                                        &nbsp;
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server" ControlToValidate="txtRReason"
                                            CssClass="Label" Display="Dynamic" ErrorMessage="Reject Reason Code is a mandatory field"
            ...
            <table id="TABLE3" cellspacing="0" cellpadding="0" width="100%" border="0" runat="server">
                ...
                <tr>
                    ...
                    <td style="height: 20px; background-color: #c6efef;" class="Title" colspan="1">
                        <asp:Label ID="Label5" runat="server" Width="300px" Text="Update Reject Reason" CssClass="LabelHeadGreen"></asp:Label></td>
                    <td class="Title" colspan="1" style="height: 20px">
                    </td>
                </tr>
                <tr>
                    ...
                    <td style="height: 10px">
                        <table id="Table2" runat="server" border="0" cellpadding="0" cellspacing="0"
                            ...
                            <tbody>
                                <tr>
                                    <td style="width: 170px; height: 19px">
                                        <asp:Label ID="Label4" runat="server" CssClass="Label" Text="Reject Reason Code"
                                            Width="83%"></asp:Label>
                                    </td>
                                    <td style="width: 10px; height: 19px">
                                        :</td>
                                    <td style="width: 640px; height: 19px">
                                        <asp:Label ID="lblRReason" CssClass="Label" runat="server"></asp:Label></td>
                                </tr>
                                <tr>
                                    <td style="width: 170px; height: 19px">
                                    </td>
                                ...
                                <tr>
                                    <td style="width: 170px; height: 19px">
                                        <asp:Label ID="Label2" runat="server" CssClass="Label" Text="ID"></asp:Label><asp:Label
                                            ID="Label15" runat="server" CssClass="Label" Font-Bold="False" ForeColor="Red"
                                            Text="*"></asp:Label></td>
                                    <td style="width: 10px; height: 19px">
                                        :</td>
                                    <td style="width: 640px; height: 19px">
                                ...
                                <tr>
                                    ...
                                    <td style="width: 640px; height: 49px">
                                        <asp:TextBox ID="txtUDesc" runat="server" Height="41px" MaxLength="1024" TextMode="MultiLine"
                                            Width="553px"></asp:TextBox>
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="txtUDesc"
                                            CssClass="Label" Display="Dynamic" ErrorMessage="Description is a mandatory field"
