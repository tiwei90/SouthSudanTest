<%@ Page Language="C#" MasterPageFile="~/iden.master" AutoEventWireup="true"
    Inherits="PersoMapping" Codebehind="PersoMapping.aspx.cs" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Content" runat="Server">
    <asp:Panel ID="Panel1" runat="server" BackImageUrl="./images/bg.gif" Height="28px"
        ...
        <asp:Label ID="fly" runat="server" BackColor="Transparent" CssClass="HeaderMainTitle"
            Height="16px" Width="353px">Visa - Production Location Configuration</asp:Label></asp:Panel>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="Title" style="height: 20px; background-color: #c6efef;">
                            <asp:Label ID="Label3" runat="server" Text="List of Production Location Configurations" CssClass="LabelHeadGreen"
                    ...
                    <tr>
                        ...
                        <td align="center" style="width: 782px">                        
                            <asp:GridView ID="gvPersoBranch" runat="server" AllowPaging="True" CellPadding="3" CssClass="Label"
                                ForeColor="#333333" GridLines="None" 
                                OnPageIndexChanging="PageIndexChanging_Click"  
                                 OnSelectedIndexChanged="gvPersoBranch_SelectedIndexChanged" AutoGenerateColumns="False" Width="781px">
                                <PagerSettings FirstPageText="&lt;&lt;" PreviousPageText="Previous" NextPageText="Next"
                                    LastPageText="&gt;&gt;"></PagerSettings>
                                <Columns>
                                    <asp:BoundField DataField="ID" HeaderText="ID" />
                                    <asp:BoundField DataField="ENROLLMENTBRANCH" HeaderText="ENROLLMENT BRANCH" />
                                    <asp:BoundField DataField="PERSOBRANCH" HeaderText="PRODUCTION BRANCH" />
            ...
            <table id="TABLE1" cellspacing="0" cellpadding="0" width="100%" border="0" runat="server">
                ...
                <tr>
                    ...
                    <td style="height: 20px; background-color: #c6efef;" class="Title" colspan="1">
                        <asp:Label ID="Label1" runat="server" Width="300px" Text="Insert New Production Branch"
                            ...
                            <tbody>
                                <tr>
                                    <td style="width: 150px; height: 19px">
                                        <asp:Label ID="Label6" runat="server" CssClass="Label" Text="Enrollment Branch"></asp:Label>
                                    ...
                                    <td style="width: 640px; height: 19px">
                                        <asp:DropDownList ID="ddlEnrolBranch" runat="server" DataTextField="BRANCHNAME" DataValueField="BRANCHCODE" AutoPostBack="True" >
                                        </asp:DropDownList>
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="ddlEnrolBranch"
                                        CssClass="Label" Display="Dynamic" ErrorMessage="Enrollment branch is a mandatory field"
                                ...
                                <tr>
                                    <td valign="top">
                                        <asp:Label ID="Label10" runat="server" CssClass="Label" Text="Production Branch"></asp:Label>
                                        <asp:Label ID="Label4" runat="server" CssClass="Label" Font-Bold="False" ForeColor="Red"
                                            Text="*"></asp:Label></td>
                                    <td style="width: 10px" valign="top">
                                        :</td>
                                    <td>
                                        <asp:DropDownList ID="ddlPersoBranch" runat="server" DataTextField="BRANCHNAME" DataValueField="BRANCHCODE">
                                        </asp:DropDownList>
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="ddlPersoBranch"
                                        CssClass="Label" Display="Dynamic" ErrorMessage="Production branch is a mandatory field"
                                        ValidationGroup="Insert" ForeColor="White">*</asp:RequiredFieldValidator></td>
                                </tr>
                            </tbody>
                        </table>
            ...
            <table id="TABLE3" cellspacing="0" cellpadding="0" width="100%" border="0" runat="server">
                ...
                <tr>
                    ...
                    <td style="height: 14px; background-color: #c6efef;" class="Title" colspan="1">
                        <asp:Label ID="Label5" runat="server" Width="300px" Text="Update Production Branch"
                            CssClass="LabelHeadGreen"></asp:Label></td>
                    ...
                    <td style="height: 10px">
                        <table style="width: 800px" id="TABLE5" cellspacing="0" cellpadding="0" border="0"
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td valign="top">
                                        <asp:Label ID="Label8" runat="server" CssClass="Label" Text="Enrollment Branch"></asp:Label>
                                        </td>
                                    <td style="width: 10px" valign="top">
                                        :</td>
                                    <td>
                                        <asp:Label ID="lblEnrolBranch" runat="server" CssClass="Label"></asp:Label></td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    <td valign="top" style="height: 19px">
                                        <asp:Label ID="Label16" runat="server" CssClass="Label" Text="Production Branch"></asp:Label>
                                        </td>
                                    <td style="width: 10px; height: 19px;" valign="top">
                                        :</td>
                                    <td style="height: 19px"><asp:DropDownList ID="ddlUPersoBranch" runat="server" DataTextField="BRANCHNAME" DataValueField="BRANCHCODE">
                                    </asp:DropDownList><asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server"
                                        ControlToValidate="ddlUPersoBranch" CssClass="Label" Display="Dynamic" ErrorMessage="Production branch is a mandatory field"
