<%@ Page Language="C#" MasterPageFile="~/iden.master" AutoEventWireup="true"
    Inherits="EntryType" Codebehind="EntryType.aspx.cs" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Content" runat="Server">
    <asp:Panel ID="Panel1" runat="server" BackImageUrl="./images/bg.gif" Height="24px"
        ...
        <asp:Label ID="fly" runat="server" BackColor="Transparent" CssClass="HeaderMainTitle"
            Height="16px" Width="353px">Visa - Entry Type </asp:Label></asp:Panel>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="Title" style="height: 20px; background-color: #c6efef;">
                            <asp:Label ID="Label3" runat="server" Text="List of Entry Types" CssClass="LabelHeadGreen"
                    ...
                    <tr>
                        ...
                        <td align="center" style="width: 782px">                        
                            <asp:GridView ID="gvEntryType" runat="server" AllowPaging="True" CellPadding="3" CssClass="Label"
                                ForeColor="#333333" GridLines="None" PageSize="5" 
                                OnPageIndexChanging="PageIndexChanging_Click"  
                                 OnSelectedIndexChanged="gvEntryType_SelectedIndexChanged" AutoGenerateColumns="False" Width="781px">
            ...
            <table id="TABLE1" cellspacing="0" cellpadding="0" width="100%" border="0" runat="server">
                ...
                <tr>
                    ...
                    <td style="height: 20px; background-color: #c6efef; width: 803px;" class="Title" colspan="1">
                        <asp:Label ID="Label1" runat="server" Width="300px" Text="Insert New Entry Type"
                        ...
                        <table style="width: 800px" id="Table6" cellspacing="0" cellpadding="0" border="0"
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <asp:TextBox ID="txtEntryType" runat="server" MaxLength="2"></asp:TextBox>                                    
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="txtEntryType"
                                ...
                                <tr>
                                    ...
                                    <td style="width: 10px" valign="top">
                                        :</td>
                                    <td>
                                        <asp:TextBox ID="txtDesc" runat="server" MaxLength="50" Width="345px"></asp:TextBox>
            ...
            <table id="TABLE3" cellspacing="0" cellpadding="0" width="100%" border="0" runat="server">
                ...
                <tr>
                    ...
                    <td style="height: 20px; background-color: #c6efef;" class="Title" colspan="1">
                        <asp:Label ID="Label5" runat="server" Width="300px" Text="Update Entry Type"
                            CssClass="LabelHeadGreen"></asp:Label></td>
                    <td class="Title" colspan="1" style="height: 20px">
                        &nbsp;</td>
                </tr>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td style="width: 10px" valign="top">
                                        :</td>
                                    <td>
                                        <asp:TextBox ID="txtUDesc" runat="server" MaxLength="50" Width="345px"></asp:TextBox>
