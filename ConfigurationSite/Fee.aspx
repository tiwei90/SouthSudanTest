<%@ Page Language="C#" MasterPageFile="~/iden.master" AutoEventWireup="true"
    Inherits="Fee" Codebehind="Fee.aspx.cs" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Content" runat="Server">
    <asp:Panel ID="Panel1" runat="server" BackImageUrl="./images/bg.gif" Height="24px"
        ...
        <asp:Label ID="fly" runat="server" BackColor="Transparent" CssClass="HeaderMainTitle"
            Height="16px" Width="353px">Visa - Fee </asp:Label></asp:Panel>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="Title" style="height: 20px; background-color: #c6efef;">
                            <asp:Label ID="Label3" runat="server" Text="List of Fees" CssClass="LabelHeadGreen"
                    ...
                    <tr>
                        ...
                        <td align="center" style="width: 782px">                        
                            <asp:GridView ID="gvFee" runat="server" AllowPaging="True" CellPadding="3" CssClass="Label"
                                ForeColor="#333333" GridLines="None" PageSize="5" 
                                OnPageIndexChanging="PageIndexChanging_Click"  
                                 OnSelectedIndexChanged="gvFee_SelectedIndexChanged" AutoGenerateColumns="False" Width="781px">
            ...
            <table id="TABLE1" cellspacing="0" cellpadding="0" width="100%" border="0" runat="server">
                ...
                <tr>
                    ...
                    <td style="height: 20px; background-color: #c6efef; width: 803px;" class="Title" colspan="1">
                        <asp:Label ID="Label1" runat="server" Width="300px" Text="Insert New Fee"
                            ...
                            <tbody>
                                <tr>
                                    <td style="width: 150px; height: 19px">
                                        <asp:Label ID="Label6" runat="server" CssClass="Label" Text="Entry Type"></asp:Label>
                                    ...
                                    <td style="width: 640px; height: 19px">
                                        <asp:DropDownList ID="ddlEntryType" runat="server" DataTextField="Description" DataValueField="EntryType">
                                        </asp:DropDownList>
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="ddlEntryType"
                                        CssClass="Label" Display="Dynamic" ErrorMessage="Entry type is a mandatory field"
                                ...
                                <tr>
                                    <td valign="top" style="height: 24px">
                                        <asp:Label ID="Label10" runat="server" CssClass="Label" Text="Fee"></asp:Label>
                                    ...
                                    <td style="height: 24px">
                                        <asp:TextBox ID="txtFee" runat="server" MaxLength="5" Width="145px"></asp:TextBox>
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtFee"
                                        CssClass="Label" Display="Dynamic" ErrorMessage="Fee is a mandatory field"
                                        ValidationGroup="Insert" ForeColor="White">*</asp:RequiredFieldValidator>
                                        <asp:RegularExpressionValidator ID="RegularExpressionValidator2" runat="server" ControlToValidate="txtFee"
                                            CssClass="Label" Display="Dynamic" ErrorMessage="Fee - only numeric characters [0-9] allowed"
            ...
            <table id="TABLE3" cellspacing="0" cellpadding="0" width="100%" border="0" runat="server">
                ...
                <tr>
                    ...
                    <td style="height: 20px; background-color: #c6efef;" class="Title" colspan="1">
                        <asp:Label ID="Label5" runat="server" Width="300px" Text="Update Fee"
                            CssClass="LabelHeadGreen"></asp:Label></td>
                    <td class="Title" colspan="1" style="height: 20px">
                        &nbsp;</td>
                </tr>
                    ...
                    <td style="height: 10px">
                        <table style="width: 800px" id="TABLE5" cellspacing="0" cellpadding="0" border="0"
                            ...
                            <tbody>
                                <tr>
                                    <td style="width: 150px; height: 19px">
                                        <asp:Label ID="Label11" runat="server" CssClass="Label" Text="ID"></asp:Label></td>
                                    <td style="width: 10px; height: 19px">
                                        :</td>
                                    <td style="width: 640px; height: 19px">
                                ...
                                <tr>
                                    <td style="width: 150px; height: 19px">
                                        <asp:Label ID="Label7" runat="server" Text="Entry Type" CssClass="Label"></asp:Label></td>
                                    <td style="width: 10px; height: 19px">
                                        :</td>
                                    <td style="width: 640px; height: 19px">
                                        <asp:Label ID="lblEntryType" CssClass="Label" runat="server"></asp:Label></td>
                                </tr>
                                <tr>
                                    <td style="width: 78px; height: 19px">
                                        &nbsp;</td>
                                    ...
                                    <td style="width: 299px; height: 19px">
                                        <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ControlToValidate="txtUFee"
                                            CssClass="Label" Display="Dynamic" ErrorMessage="Fee - only numeric characters [0-9] allowed"
                                            ValidationExpression="(\d){1,99}" ValidationGroup="Update" ForeColor="White">*</asp:RegularExpressionValidator></td>
                                </tr>
                                <tr>
                                    <td valign="top">
                                        <asp:Label ID="Label8" runat="server" Text="Fee" CssClass="Label"></asp:Label>
                                        <asp:Label ID="Label2" runat="server" CssClass="Label" Font-Bold="False" ForeColor="Red"
                                            Text="*"></asp:Label></td>
                                    <td style="width: 10px" valign="top">
                                        :</td>
                                    <td>
                                        <asp:TextBox ID="txtUFee" runat="server" MaxLength="5" Width="145px"></asp:TextBox>&nbsp;
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" CssClass="Label"
                                            ErrorMessage="Fee is a mandatory field" ValidationGroup="Update" ControlToValidate="txtUFee"
