<%@ Page Language="C#" MasterPageFile="~/iden.master" AutoEventWireup="true"
    Inherits="ApplicationReason" Codebehind="ApplicationReason.aspx.cs" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Content" runat="Server" >
    <asp:Panel ID="Panel1" runat="server" BackImageUrl="./images/bg.gif" Height="24px"
        ...
        <asp:Label ID="fly" runat="server" BackColor="Transparent" CssClass="HeaderMainTitle"
            Height="16px" Width="353px">Visa - Application Reason</asp:Label></asp:Panel>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="Title" style="height: 20px; background-color: #c6efef;">
                            <asp:Label ID="Label3" runat="server" Text="List of Application Reasons" CssClass="LabelHeadGreen"
                    ...
                    <tr>
                        ...
                        <td align="center">                        
                            <asp:GridView ID="gvAppReason" runat="server" AllowPaging="True" CellPadding="3" CssClass="Label"
                                ForeColor="#333333" GridLines="None" PageSize="5" 
                                OnPageIndexChanging="PageIndexChanging_Click"  
                                 OnSelectedIndexChanged="gvAppReason_SelectedIndexChanged" AutoGenerateColumns="False" Width="781px">
                                <PagerSettings FirstPageText="&lt;&lt;" PreviousPageText="Previous" NextPageText="Next"
                                    LastPageText="&gt;&gt;"></PagerSettings>
                                <Columns>
                                    <asp:BoundField DataField="APPREASON" HeaderText="APPLICATION REASON" />
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td style="height: 20px; background-color: #c6efef;" class="Title" colspan="1">
                            <asp:Label ID="Label1" runat="server" Width="300px" Text="Insert New Application Reason"
                                ...
                                <tbody>
                                    <tr>
                                        <td style="width: 150px; height: 19px">
                                            <asp:Label ID="Label6" runat="server" CssClass="Label" Text="Application Reason"></asp:Label>
                                        ...
                                        <td style="width: 640px; height: 19px">
                                            <asp:TextBox ID="txtAppReason" runat="server"></asp:TextBox><asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" CssClass="Label"
                                                ErrorMessage="Application Reason - only numeric characters [0-9] allowed" ControlToValidate="txtAppReason"
                                                ValidationExpression="(\d){1,99}" ValidationGroup="Insert" Display="Dynamic">*</asp:RegularExpressionValidator><asp:RequiredFieldValidator
                                                    ID="RequiredFieldValidator2" runat="server" ControlToValidate="txtAppReason"
                                                    CssClass="Label" Display="Dynamic" ErrorMessage="Application Reason is a mandatory field"
                                    ...
                                    <tr>
                                        ...
                                        <td style="width: 9px" valign="top">
                                            :</td>
                                        <td>
                                            <asp:TextBox ID="txtDesc" runat="server" Height="51px" MaxLength="1024" TextMode="MultiLine"
            ...
            <table id="TABLE3" cellspacing="0" cellpadding="0" width="100%" border="0" runat="server">
                ...
                <tr>
                    ...
                    <td style="height: 20px; background-color: #c6efef; width: 808px;" class="Title" colspan="1">
                        <asp:Label ID="Label5" runat="server" Width="300px" Text="Update Application Reason"
                            CssClass="LabelHeadGreen"></asp:Label></td>
                    ...
                    <td style="height: 10px; width: 808px;">
                        <table style="width: 800px" id="TABLE5" cellspacing="0" cellpadding="0" border="0"
                            ...
                            <tbody>
                                <tr>
                                    <td style="width: 150px; height: 19px">
                                        <asp:Label ID="Label7" runat="server" Text="Application Reason" CssClass="Label"></asp:Label></td>
                                    <td style="width: 9px; height: 19px">
                                        :</td>
                                    <td style="width: 640px; height: 19px">
                                        <asp:Label ID="lblUAppReason" runat="server" Text="Application Reason" CssClass="Label"></asp:Label></td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td style="width: 450px">
                                        <asp:TextBox ID="txtUDesc" runat="server" MaxLength="1024" Width="414px" Height="51px" TextMode="MultiLine"></asp:TextBox>
