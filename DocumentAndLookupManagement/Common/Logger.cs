...
namespace DocumentAndLookupManagement.Common
{
    public sealed class Logger
    {
        //private static string LogPath = "C://" + Settings.Default._logpath;
        private static string LogPath = HttpContext.Current.Server.MapPath(Settings.Default._logpath);
        //private static string TracePath = Environment.CurrentDirectory.ToString() +"\\"+ Settings.Default.TracePath ;
