<%@ Page Language="C#" AutoEventWireup="true" Inherits="EnrollmentIssuanceSite.PermissionErrorPage" Codebehind="PermissionErrorPage.aspx.cs" %>
	...
	<body>
		<form id="Form1" method="post" runat="server">
			<asp:Label id="Label1" style="Z-INDEX: 101; LEFT: 160px; POSITION: absolute; TOP: 88px" runat="server"
				CssClass="Label" ForeColor="Red" Width="100%" Font-Bold="True">Sorry, you are not authorize to access the system.</asp:Label>
