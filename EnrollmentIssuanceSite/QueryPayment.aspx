<%@ Page MasterPageFile="~/iden.master" Language="C#" AutoEventWireup="true" Inherits="EnrollmentIssuanceSite.QueryPayment" Codebehind="QueryPayment.aspx.cs" %>
...
<asp:Panel ID="Panel1" runat="server" Height="28px" BackImageUrl="./images/bg.gif"
        Width="100%">
        <asp:Label ID="fly" runat="server" Height="16px" CssClass="HeaderMainTitle" ForeColor="DimGray" BackColor="Transparent" Text="Visa - Search Pending Payment" ></asp:Label></asp:Panel>
            ...
            <tr>
                ...
                <tr id="trDOB" runat="server" visible="false">
                    ...
                    <tr runat="server" visible="false" id="trBirthCountry">
                        ...
                        <td style="width: 143px; height: 22px">
                            <asp:Label ID="lblCountry" runat="server" CssClass="Label" Text="Country of Issue" Width="97px"></asp:Label><asp:Label
                    ...
                    <tr runat="server" visible="false" id="trBranch">
                        ...
                        <td style="width: 143px; height: 22px">
                            <asp:Label ID="Label2" runat="server" CssClass="Label" Text="Branch" Width="41px"></asp:Label><asp:Label
                                ID="Label3" runat="server" CssClass="Label" EnableViewState="False" ForeColor="Red">*</asp:Label><asp:RequiredFieldValidator
                                    ID="RequiredFieldValidator1" runat="server" ControlToValidate="DDBRANCH"
                                    CssClass="Label" ErrorMessage="Branch is mandatory" ForeColor="White">*</asp:RequiredFieldValidator></td>
                        <td colspan="2" style="width: 755px; height: 22px">
                    ...
                    <tr>
                        ...
                        <td colspan="6">
                            <asp:GridView ID="dgByName" runat="server" AllowPaging="True" CellPadding="3" CssClass="Label"
                                ForeColor="#333333" GridLines="None" Width="785px" OnPageIndexChanging="dgByName_PageIndexChanging" AllowSorting="True" AutoGenerateColumns="False" OnRowCommand="dgByName_RowCommand" PageSize="5">
                                <Columns>
