<%@ Page MasterPageFile="~/iden.master" Language="C#" AutoEventWireup="true" Inherits="EnrollmentIssuanceSite.Search" Codebehind="Search.aspx.cs" %>

<asp:Content ContentPlaceHolderID="Content" runat="server">
<asp:Panel ID="Panel1" runat="server" Height="28px" BackImageUrl="./images/bg.gif"
        Width="100%">
        <asp:Label ID="fly" runat="server" Height="16px" CssClass="HeaderMainTitle" ForeColor="DimGray" BackColor="Transparent" Width="353px" >Visa - Search Partial Enrollment</asp:Label></asp:Panel>
        ...
        <table id="tbQuery" cellspacing="2"  cellpadding="0" width="99%" border="0" runat="server" visible="false">
            <tr>
                ...
                <tr>               
                    ...
                    <td style="height: 22px; width: 143px;">
                        <asp:Label ID="Label4" runat="server" CssClass="Label" Width="58px">Search by</asp:Label>
                ...
                <tr id="trSearchValue" runat="server" visible="false">
                    ...
                    <td style="height: 22px; width: 143px;">
                        <asp:Label ID="lblName" runat="server" CssClass="Label" Width="80px">Application ID</asp:Label><asp:Label
                    ...
                    <td style="height: 22px;" colspan="2">
                        ...
                        <asp:RequiredFieldValidator ID="RFVSearchValue" runat="server" ControlToValidate="SEARCHVALUE"
                            CssClass="Label" ForeColor="White">*</asp:RequiredFieldValidator></td>
                </tr>
                <tr runat="server" visible="false" id="trFirstname">
                    ...
                    <td style="width: 143px; height: 22px">
                        ...
                        <asp:CustomValidator ID="CustomValidator1" runat="server" ErrorMessage="Please enter required data before pressing the <SEARCH> button"
                            ForeColor="White" OnServerValidate="CustomValidator1_ServerValidate" ClientValidationFunction="CheckEmpty" ControlToValidate="SEARCHFIRST" ValidateEmptyText="True">*</asp:CustomValidator></td>
                ...
                <tr id="trDOB" runat="server" visible="false">
                    ...
                    <td style="width: 143px; height: 22px">
                        <asp:Label ID="Label1" runat="server" CssClass="Label" Text="Date of Birth"></asp:Label></td>
                    <td colspan="2" style="height: 22px">
                        <asp:TextBox ID="BIRTHDATE" runat="server" ReadOnly="True" Width="164px" EnableViewState="False"></asp:TextBox><asp:ImageButton ID="ImageButton6" runat="server" CausesValidation="False" ImageUrl="~/images/button.gif"
                            OnClientClick="CalPick('BIRTHDATE','X','Applicant Birthdate');return false;" TabIndex="4" /></td>
                </tr>
                 <tr id="trPOI" runat="server" visible="false">
                    <td style="width: 8px; height: 21px">
                    </td>
                    <td style="width: 143px; height: 21px">
                        <asp:Label ID="Label22" runat="server" CssClass="Label" Text="Country of Issue" Width="91px"></asp:Label><asp:Label
                            ID="Label26" runat="server" CssClass="Label" EnableViewState="False" ForeColor="Red">*</asp:Label>&nbsp;
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ControlToValidate="PASSPORTPOI"
                            CssClass="Label" ErrorMessage="Country of Issue is mandatory" ForeColor="White">*</asp:RequiredFieldValidator></td>
                    <td colspan="2" style="height: 21px">
                        <asp:DropDownList ID="PASSPORTPOI" runat="server" CssClass="Label">
                        </asp:DropDownList></td>
                </tr>
                 <tr id="trBranch" runat="server" visible="false">
                    ...
                    <td style="width: 143px; height: 21px">
                        <asp:Label ID="Label23" runat="server" CssClass="Label" Text="Branch" Width="43px"></asp:Label><asp:Label
                            ID="Label24" runat="server" CssClass="Label" EnableViewState="False" ForeColor="Red">*</asp:Label>
                ...
                <tr>
                    ...
                    <td colspan="2" style="height: 22px">
                        ...
                        <input id="btnClear" runat="server" type="button" value="Clear" tabindex="1" onclick="Clear();" disabled="disabled" />
                        <asp:Button ID="btnViewAll" runat="server" CausesValidation="False" OnClick="btn_ViewAll_Click"
                            Text="View All" TabIndex="2" /></td>                   
               ...
               <tr>
                    ...
                    <asp:ValidationSummary ID="ValidationSummary1" runat="server" CssClass="Label" ShowMessageBox="True"
                        ShowSummary="False" Height="18px" Width="261px" />
                        &nbsp;&nbsp;
                    </td>
               </tr>
            </table>
        ...
        <table id="tbIncomplete" cellspacing="2"  cellpadding="0" width="98%" border="0" runat="server" >
            <tr>
                <td style="width: 8px;"> </td>               
                <td colspan="3" >
                <div id="Div3" runat="server" class="PanelSearch">
                <table style="width: 100%">
                    <tr>
                        <td style="width: 8px; height: 10px">
                        </td>
                ...
                <tr>               
                    ...
                    <td style="height: 22px; width: 143px;">
                        <asp:Label ID="Label18" runat="server" CssClass="Label" Width="77px">Application ID</asp:Label><asp:RequiredFieldValidator
                                ID="RequiredFieldValidator3" runat="server" ControlToValidate="ddlfiles" CssClass="Label"
                                ErrorMessage="Please select Application ID" ForeColor="White">*</asp:RequiredFieldValidator></td>
                    <td style="height: 22px;" colspan="2">
                    <asp:DropDownList ID="ddlfiles" runat="server" Width="171px">
                    </asp:DropDownList>
                        <asp:Button ID="btnSearch2" runat="server" Text="Resume Enrollment" TabIndex="-1" OnClick="btnSearch2_Click" Width="142px"></asp:Button></td>
                ...
                <tr>
                    ...
                    <td colspan="2" style="height: 22px">
                        <asp:Label ID="lblMsgSearch2" runat="server" CssClass="Label" EnableViewState="False"
               ...
               <tr>
                    ...
                    <td colspan="3" style="height: 19px">
                    <asp:ValidationSummary ID="ValidationSummary2" runat="server" CssClass="Label" ShowMessageBox="True"
                        ShowSummary="False" />
        ...
        <table id="tbdgInfo" cellspacing="2"  cellpadding="0" width="99%" border="0" runat="server" visible="false">
            ...
            <tr>
                ...
                <table width="98%" border="0" cellspacing="2" cellpadding="0" id="Table1"  runat="server">
                    <tr>
                        ...
                        <td colspan="6">
                           <asp:GridView ID="dgByName" runat="server" AllowPaging="True" CellPadding="4" CssClass="DataGrid"
                                ...
                                <Columns>
                                 ...
                                 <ItemTemplate>
                                     ...
                                     <HeaderStyle HorizontalAlign="Left" Width="100px" VerticalAlign="Top" />
                                 </asp:TemplateField>   
                                ...
                                <asp:TemplateField HeaderText="NATIONAL ID NO.">
                                    <ItemTemplate>
                                        <asp:Label ID="lblNIS" runat="server" Text='<%# Eval("NationalIDNo") %>'></asp:Label>
                                    </ItemTemplate>
                                    <HeaderStyle HorizontalAlign="Left" Width="90px" VerticalAlign="Top" />
                                </asp:TemplateField>
            ...
            <tr>
               ...
               <table width="98%" border="0" cellspacing="2" cellpadding="0" id="Table2"  runat="server">
                   ...
                   <tr>
                       ...
                       <td style="width: 288px; height: 19px">
                            <asp:Label ID="FIRSTNAME" runat="server" CssClass="Label" Width="172px"></asp:Label></td><td style="width: 140px; height: 19px">
                                <asp:Label ID="Label8" runat="server" CssClass="Label" Text="Application Category"
                                    Width="130px"></asp:Label></td>
                       <td style="width: 9px; height: 19px">
                           :</td>
                       <td style="height: 19px">
                           <asp:Label ID="PRIORITY" runat="server" CssClass="Label" Width="197px"></asp:Label></td>
                   </tr>
                   <tr>
                       <td style="width: 8px; height: 19px">
                       </td>
                       ...
                       <td style="width: 10px; height: 19px">
                           :</td>
                       <td style="width: 288px; height: 19px">
                            <asp:Label ID="MIDDLENAME" runat="server" CssClass="Label" Width="172px"></asp:Label></td><td style="width: 140px; height: 19px">
                                <asp:Label ID="Label10" runat="server" CssClass="Label" Text="Application Status"
                                    Width="99px"></asp:Label></td>
                       <td style="width: 9px; height: 19px">
                           :</td><td style="height: 19px">
                               <asp:Label ID="STAGECODE" runat="server" CssClass="Label" Width="190px"></asp:Label></td>
                   </tr>
                   <tr>
                       <td style="width: 8px; height: 19px">
                       </td>
                       ...
                       <td style="width: 140px; height: 19px">
                            <asp:Label ID="Label12" runat="server" CssClass="Label" Text="Passport Type"></asp:Label></td>
                       <td style="width: 9px; height: 19px">
                           :</td>
                       <td style="height: 19px">
                   ...
                   <tr>
                       ...
                       <td style="width: 140px; height: 19px">
                            <asp:Label ID="Label20" runat="server" Text="Date of Application" CssClass="Label"></asp:Label></td>
                       <td style="width: 9px; height: 19px">:
                       </td>
                       <td style="height: 19px">
                   ...
                   <tr>
                       ...
                       <td style="width: 146px; height: 19px">
                            <asp:Label ID="Label21" runat="server" CssClass="Label" Text="National Insurance No" Width="124px"></asp:Label></td>
                       <td style="width: 10px; height: 19px">
                           :</td>
                       <td style="width: 288px; height: 19px">
                   ...
                   <tr>
                       ...
                       <td colspan="3" style="height: 19px">
                        <asp:Button ID="btn_Submit" runat="server" Text="Update Application" OnClick="btn_Submit_Click" Visible="False" Width="124px"></asp:Button></td>
                       <td style="width: 140px; height: 19px">
                       </td>
                       <td style="width: 9px; height: 19px">
                       </td>
