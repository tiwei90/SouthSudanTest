<%@ Page MasterPageFile="~/iden.master" Language="C#" AutoEventWireup="true"  Inherits="EnrollmentIssuanceSite.usercontrol_ObsoletePassport" Codebehind="ObsoleteVisa.aspx.cs" %>

<asp:Content ID="Content1" ContentPlaceHolderID="Content" runat="server">
<asp:Panel ID="Panel1" runat="server" Height="28px" BackImageUrl="./images/bg.gif"
        Width="100%">
        <asp:Label ID="fly" runat="server" Height="16px" CssClass="HeaderMainTitle" ForeColor="DimGray" BackColor="Transparent" Width="353px" >Visa - Obsolete Visa</asp:Label></asp:Panel>
            ...
            <tr>
                ...
                <tr>               
                    ...
                    <td style="height: 22px; width: 143px;">
                        <asp:Label ID="Label4" runat="server" CssClass="Label" Width="58px">Search by</asp:Label><asp:RequiredFieldValidator
                            ID="RequiredFieldValidator4" runat="server" ControlToValidate="SEARCHBY" CssClass="Label"
                            ErrorMessage="Please select search category before pressing the <SEARCH> button"
                ...
                <tr id="trSearchValue" runat="server" visible="false">
                    ...
                    <td style="height: 22px; width: 143px;">
                        <asp:Label ID="lblName" runat="server" CssClass="Label">Application ID</asp:Label>
                        <asp:Label ID="Label3" runat="server" CssClass="Label" EnableViewState="False" ForeColor="Red">*</asp:Label></td>
                    <td style="height: 22px;" colspan="2">
                ...
                <tr runat="server" visible="false" id="trFirstname">
                    ...
                    <td style="width: 143px; height: 22px">
                        <asp:Label ID="Label15" runat="server" CssClass="Label">First Name</asp:Label>
                ...
                <tr id="trCOI" visible="false" runat="server">
                    <td style=" width: 8px;">
                    </td>
                    <td style="width: 143px; ">
                        <asp:Label ID="Label2" runat="server" CssClass="Label" Text="Country of Issue" Width="91px"></asp:Label><asp:Label
                            ID="Label27" runat="server" CssClass="Label" EnableViewState="False" ForeColor="Red">*</asp:Label>
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="DDPASSPORTPOI"
