<%@ Page MasterPageFile="~/iden.master" Language="C#" AutoEventWireup="true" Inherits="EnrollmentIssuanceSite.VisaPayment" Codebehind="VisaPayment.aspx.cs" %>
...
<asp:Content ContentPlaceHolderID="Content" runat="server">
 ...
 <input id="ENTRYTYPE" style="z-index: -5; left: 488px; width: 24px; position: absolute;
        top: 8px; height: 22px" type="hidden" runat="server" />
...
<asp:Panel ID="Panel1" runat="server" Height="28px" BackImageUrl="./images/bg.gif"
        Width="100%">
        <asp:Label ID="fly" runat="server" Height="16px" CssClass="HeaderMainTitle" ForeColor="DimGray" BackColor="Transparent" Width="353px" >Visa - Visa Payment</asp:Label></asp:Panel>
 <table id="tbInfo" cellspacing="2"  cellpadding="0" width="98%" border="0" runat="server">
            ...
            <tr>
                ...
                <td colspan="3" style="height: 19px; background-color: #c6efef;">
                    &nbsp;&nbsp;
                    <asp:Label ID="Label11" runat="server" CssClass="LabelHeadGreen" Text="Payment Details"></asp:Label></td>
            </tr>
            <tr>
               ...
               <table width="98%" border="0" cellspacing="2" cellpadding="0" id="tbInfo2"  runat="server">
                   ...
                   <tr>
                       ...
                       <td style="width: 242px; height: 19px">
                           ...
                           <asp:Button ID="btnChange" runat="server" CausesValidation="False"
                                   CssClass="Label" Height="25px"  Text="Change" Width="66px" OnClick="btnChange_Click" /></td>
                       <td style="width: 71px; height: 19px">
                       </td>
                       <td style="width: 9px; height: 19px">
                       </td>
                   ...
                   <tr id="trRemarks" runat="server" visible="false">
                       ...
                       <td style="width: 142px; height: 19px" valign="top">
                       ...
                       <td style="width: 242px; height: 19px">
                           <asp:TextBox ID="txtRemarks" runat="server" CssClass="Label" MaxLength="1000" ReadOnly="True"
                               Rows="5" TextMode="MultiLine" Width="256px"></asp:TextBox></td>
                       <td style="width: 71px; height: 19px">
                       </td>
                       <td style="width: 9px; height: 19px">
                       </td>
        ...
        &nbsp;<asp:Label ID="Label1" runat="server" CssClass="Label" Text="User Name"
            ...
            <td style="WIDTH: 394px; height: 25px;">
                ...
                <asp:Button ID="btnCancel" runat="server" CausesValidation="False" OnClick="btnCancel_Click"
                   ...
                   <tr>
                       ...
                       <td colspan="6" style="height: 19px">
                           <asp:Button ID="btnSave" runat="server" OnClick="btnSave_Click" Text="Submit Payment" CausesValidation="true" Visible="true" Width="119px" />
