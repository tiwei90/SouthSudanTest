...
{
    public partial class QueryIssuance : System.Web.UI.Page
    {
        ...
        protected void dgByName_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            ...
            if (e.CommandName == "Select")
            {
                ...
                Response.Redirect("IssuanceDetails.aspx?arrow=" + Request.QueryString["arrow"] + "&done=" + FORMNO + "&sm=" + sm + "&PC=" + txtCompName.Value);
        ...
        private DataView BindGrid()
        {
            ...
            string query = "StageCode LIKE 'PM2000%'";
            dv.RowFilter = query;
            return dv;
            #endregion
        ...
        private void FilterDG()
        {
            ...
            dv.RowFilter = "StageCode Like 'PM2000%'";
            #endregion
            ...
            if (i == 0)
            {
                lblMsgSearch.Text = "Record is not available for issuance.";
                lblMsgSearch.Visible = true;
                tbDataGrid.Visible = false;
            }
            else
        ...
        private void SEARCH(string SearchMode, string NIS, string AppID, string PassportNo, string PassportCOI)
        {
            ...
            try
            {
                ...
                if (statusCode == "0")
                {
                    ...
                    if (responseData.StageCode.Substring(0, 6) == "PM2000")
                    {
                        FORMNO.Value = responseData.ApplicationID;
                        tbDataGrid.Visible = false;
                        lblMsgSearch.Visible = false;
                        Response.Redirect("IssuanceDetails.aspx?arrow=" + Request.QueryString["arrow"] + "&done=" + FORMNO.Value + "&sm=" + sm + "&PC=" + txtCompName.Value);
                    }
                    else
                    {
                        lblMsgSearch.Visible = true;
        ...
        protected void btnSearch_Click(object sender, EventArgs e)
        {
            ...
            else if (SEARCHBY.SelectedValue == "5") // DOC NO
            {
