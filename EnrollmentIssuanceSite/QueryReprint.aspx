<%@ Page MasterPageFile="~/iden.master" Language="C#" AutoEventWireup="true" Inherits="EnrollmentIssuanceSite.QueryReprint" Codebehind="QueryReprint.aspx.cs" %>

<asp:Content ContentPlaceHolderID="Content" runat="server">
<asp:Panel ID="Panel1" runat="server" Height="28px" BackImageUrl="./images/bg.gif"
        Width="100%">
        <asp:Label ID="fly" runat="server" Height="16px" CssClass="HeaderMainTitle" ForeColor="DimGray" BackColor="Transparent" Width="353px" >Visa - Reprint Auxiliary Receipt</asp:Label></asp:Panel>
   ...
   <table id="tbInfo" cellspacing="2"  cellpadding="0" width="98%" border="0" runat="server" visible="false">
            ...
            <tr>
               ...
               <table width="98%" border="0" cellspacing="2" cellpadding="0" id="tbInfo2"  runat="server">
                   ...
                   <tr>
                       ...
                       <td style="width: 132px">
                           <asp:Label ID="Label24" runat="server" CssClass="Label" Text="Document Sub Type"></asp:Label></td>
                       <td style="width: 10px">
                           :</td>
                       <td style="width: 288px">
        ...
        <tr>
            ...
            <td style="width: 132px">
                <asp:label id="Label6" runat="server" cssclass="Label" text="Date of Application"
        ...
        <tr>
                   ...
                   <tr>
                       ...
                       <td style="width: 132px">
                            <asp:Label ID="Label18" runat="server" CssClass="Label" Text="Sex"></asp:Label></td>
                       <td style="width: 10px">
                           :</td>
                       <td style="width: 288px">
                   ...
                   <tr>
                       ...
                       <td style="width: 132px; height: 19px">
                            <asp:Label ID="Label21" runat="server" CssClass="Label" Text="Place of Birth"></asp:Label></td>
                       <td style="width: 10px; height: 19px">
                           :</td>
                       <td style="width: 288px; height: 19px">
