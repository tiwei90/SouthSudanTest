...
namespace EnrollmentIssuanceSite
{
    public partial class Query : System.Web.UI.Page
    {
        ...
        private void SEARCH(string SearchMode, string DocNo, string AppID, string PassportNo, string PassportCOI)
        {
            ...
            try
            {
                ...
                if (statusCode == "0")
                {
                    ...
                    BIRTHPLACE.Text = responseData.BirthCountry;
                    STAGECODE.Text = responseData.StageCode;
                    DOCTYPE.Text = responseData.DocType;
                    SUBDOCTYPE.Text = responseData.EntryType;
                    APPROVEDDOCTYPE.Text = responseData.ApprovedDocType;
                    APPROVEDENTRYTYPE.Text = responseData.ApprovedEntryType;
                    ...
                    #region Visa Details
                    if (responseData.StageCode.Substring(0, 6) == "PM1000" || responseData.StageCode.Substring(0, 6) == "PM2000" || responseData.StageCode.Substring(0, 6) == "EM6000")
                    {
                        VISADOI.Text = Convert.ToDateTime(responseData.DocIssueDate).ToString("dd/MM/yyyy");
                        VISADOE.Text = Convert.ToDateTime(responseData.DocExpiryDate).ToString("dd/MM/yyyy");
                        VISANO.Text = responseData.DocNo;
                        VISAPOI.Text = responseData.DocIssPlace;
                    }
                    #endregion
        ...
        private void CheckDocType(string type)
        {
            #region DOCTYPE
            //if (type == common.PORDINARY)
            //{
            //    DOCTYPE.Text = "REGULAR/ORDINARY";
            //}
            //else if (type == common.PCHILDREN)
            //{
            //    DOCTYPE.Text = "CHILDREN";
            //}
            //else if (type == common.PDIPLOMATIC)
            //{
            //    DOCTYPE.Text = "DIPLOMATIC";
            //}
            //else if (type == common.PEMERGENCY)
            //{
            //    DOCTYPE.Text = "EMERGENCY";
            //}
            //else if (type == common.POFFICIAL)
            //{
            //    DOCTYPE.Text = "OFFICIAL";
            //}
            //else if (type == common.PIDENTITY)
            //{
            //    DOCTYPE.Text = "CERTIFICATE OF IDENTITY";
            //}
            //else if (type == common.PTRAVELER)
            //{
            //    DOCTYPE.Text = "FREQUENT TRAVELER";
            //}
        ...
        protected void dgByName_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            ...
            if (e.CommandName == "Select")
            {
                ...
                // Update the record 
                imgPhoto.ImageUrl = Common.ImgDefaultUrl;
                SEARCH("1", string.Empty, FORMNO, string.Empty, string.Empty);
        ...
        private void SetPassportDetailsVisibility()
        {

            PassportTitle.Visible = Convert.ToBoolean(Common.GetValue("QPassportTitle"));
            trPassportCOI.Visible = Convert.ToBoolean(Common.GetValue("QCountryOfIssue"));
            trPassportNo.Visible = Convert.ToBoolean(Common.GetValue("QPassportNo"));
            trPassportDOI.Visible = Convert.ToBoolean(Common.GetValue("QDateOfIssue"));
            trPassportDOE.Visible = Convert.ToBoolean(Common.GetValue("QDateOfExpiry"));

            VisaTitle.Visible = Convert.ToBoolean(Common.GetValue("QVisaTitle"));
            trVisaPOI.Visible = Convert.ToBoolean(Common.GetValue("QVisaPlaceOfIssue"));
            trVisaNo.Visible = Convert.ToBoolean(Common.GetValue("QVisaNo"));
            trVisaDOI.Visible = Convert.ToBoolean(Common.GetValue("QVisaDateOfIssue"));
            trVisaDOE.Visible = Convert.ToBoolean(Common.GetValue("QVisaDateOfExpiry"));
