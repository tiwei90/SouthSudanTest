<%@ Page MasterPageFile="~/Iden.master" Language="C#" AutoEventWireup="true" Inherits="EnrollmentIssuanceSite.QueryIssuance" Codebehind="QueryIssuance.aspx.cs" %>
...
<asp:Panel ID="Panel1" runat="server" Height="28px" BackImageUrl="./images/bg.gif"
        Width="100%">
        <asp:Label ID="fly" runat="server" Height="16px" CssClass="HeaderMainTitle" ForeColor="DimGray" BackColor="Transparent" Text="Visa - Search Pending Issuance" ></asp:Label></asp:Panel>
            ...
            <tr>
                ...
                <tr id="trDOB" runat="server" visible="false">
                  ...
                  <tr runat="server" visible="false" id="trBranch">
                        ...
                        <td style="width: 143px; height: 22px">
                            <asp:Label ID="Label2" runat="server" CssClass="Label" Text="Branch" Width="43px"></asp:Label><asp:Label
